...
```bash
# создать задачу (аудио + опционально слайды) -> печатает task_id
...
| ------------ | ------------------------------------------- | ------------------------------------------------------------------------------- |
| `submit`     | `--audio <файл>` (обяз.), `--slides <файл>` | Создаёт задачу из аудио и опциональных слайдов. Печатает `task_id`.             |
